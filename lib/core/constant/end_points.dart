...
const registerWorkshopURL = 'AddWorkShop/';
const registerCarOwnerURL = '/CreateCarsOwner/';
const registerTowCarOwnerURL = 'CreateTowCarOwner/';
const registerTowCarURL = 'AddTowCar/';
...
const sliderImagesURL = 'ImageViewSet/';
const originsURL = 'AddOrigin/';
const brandsURL = 'AddBrand/';
