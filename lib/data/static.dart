...
import 'package:auto_care/view/users/car_owner/screens/requests/maintenance_request.dart/requests.dart';
...
List<OnBoardingModel> onboardingList = [
  ...
  OnBoardingModel(
      ...
      body: "A new way to Discover Workshops\nand see what is the best\n ",
      image: ImageAsset.onboarding1),
  // 2
  OnBoardingModel(
      title: "Features Overview",
      body:
          "Discover the features that make\nAutoCare a powerful solution\nfor your organization.",
      image: ImageAsset.onboarding2),
  // 3
  OnBoardingModel(
      title: "Let's Get Started",
      body:
          "Join the thousands of Car Owners\nwho are already using app to make there life ease.",
      image: ImageAsset.onboarding3),
];
// Register Select User type
List<SelectUserTypeListTile> selectTypeTile = [
  SelectUserTypeListTile(
      title: 'Car Owner',
      subTitle: 'You are a Car Owner?',
  ...
  SelectUserTypeListTile(
      ...
      subTitle: 'You are a Car Owner?',
      leadingIcon: Icons.car_crash,
      color: AppColors.listTileColor2,
      route: SharedRoutes.registerWorkshopOwnerPage),
  SelectUserTypeListTile(
      title: 'Parts Supplier',
      subTitle: 'You are a Car Owner?',
      leadingIcon: Icons.car_crash,
      color: AppColors.listTileColor3,
      route: SharedRoutes.registerPartsSupplier),
  SelectUserTypeListTile(
      title: 'Tow Car Owner',
      subTitle: 'You are a Car Owner?',
      leadingIcon: Icons.car_crash,
      color: AppColors.listTileColor4,
      route: SharedRoutes.registerTowCarOwnerPage),
];
List<TowCarOwnerDrawerListTile> towCarOwnerDrawerListTile = [
...
Map<String, Widget> tabsCarOwner = {
  ...
  'Requests & History': const CarOwnerRequestsPage(),
...
//   ImageAsset.homePageSlider2,
//   ImageAsset.homePageSlider3,
//   ImageAsset.homePageSlider4,
// ];
List<String> tyOfUser = [
  'Car Owner',
  'Tow Car Owner',
  'Workshop Owner',
  'Parts Supplier'
...
List<MaintenanceRequest> dummyRequests = [
  MaintenanceRequest(
    carMake: "Toyota",
    carModel: "Camry",
    licensePlate: "ABC123",
    serviceType: "Oil Change",
    description: "Car is due for a routine oil change.",
  ...
  MaintenanceRequest(
    ...
    description: "Experiencing squeaky brakes, needs inspection.",
  ...
  MaintenanceRequest(
    ...
    description: "Tires seem uneven, might need rotation.",
