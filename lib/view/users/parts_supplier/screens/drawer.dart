...
class PartsHomePageDrawer extends StatelessWidget {
  const PartsHomePageDrawer({
    super.key,
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ListView.builder(
                  shrinkWrap: true,
                  itemCount: partsDrawerListTile.length,
                  itemBuilder: (context, index) => ListTile(
                        title: Text(partsDrawerListTile[index].title),
                        leading: Icon(
                          partsDrawerListTile[index].leadingIcon,
                          size: 30,
                        ),
                        titleTextStyle:
                        ...
                        onTap: () {
                          Get.toNamed(partsDrawerListTile[index].route);
                        },
                      )),
              TextButton.icon(
